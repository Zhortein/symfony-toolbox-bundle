                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->scalarNode('paginator')
                            ...
                            ->end()
                        ->end()
                        ->booleanNode('ux_icons')
                            ->defaultValue(true)
                        ->end()
                        ->arrayNode('ux_icons_options')
                            ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('icon_first')
                                        ->defaultValue('bi:chevron-double-left')
                                    ->end()
                                    ->scalarNode('icon_previous')
                                        ->defaultValue('bi:chevron-left')
                                    ->end()
                                    ->scalarNode('icon_next')
                                        ->defaultValue('bi:chevron-right')
                                    ->end()
                                    ->scalarNode('icon_last')
                                        ->defaultValue('bi:chevron-double-right')
                                    ->end()
                                    ->scalarNode('icon_search')
                                        ->defaultValue('bi:search')
                                    ->end()
                                    ->scalarNode('icon_true')
                                        ->defaultValue('bi:check')
                                    ->end()
                                    ->scalarNode('icon_false')
                                        ->defaultValue('bi:x')
                                    ->end()
                                    ->scalarNode('icon_sort_asc')
                                        ->defaultValue('bi:sort-alpha-down')
                                    ->end()
                                    ->scalarNode('icon_sort_desc')
                                        ->defaultValue('bi:sort-alpha-up')
                                    ->end()
                                    ->scalarNode('icon_filter')
                                        ->defaultValue('mi:filter')
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
